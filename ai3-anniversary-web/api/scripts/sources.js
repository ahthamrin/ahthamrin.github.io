...
Timeline.DefaultEventSource.Event = function(
        ...
        text, description, image, link, onclick,
        icon, color, textColor, width, height) {
    ...
    this._onclick = (onclick != null && onclick != "") ? onclick : null;
    
    this._icon = (icon != null && icon != "") ? icon : null;
    this._color = (color != null && color != "") ? color : null;
    this._textColor = (textColor != null && textColor != "") ? textColor : null;
	this._width = (width != null && width != "") ? parseInt(width,10) : 0;
	this._height = (height != null && height != "") ? parseInt(height,10) : 0;
};
...
Timeline.DefaultEventSource.Event.prototype = {
    ...
    fillInfoBubble: function(elmt, theme, labeller) {
		...
		if (link != null) {
			...
			if (onclick == "true")
				a.onclick = function () { loadEventDesc(link); return false; };
