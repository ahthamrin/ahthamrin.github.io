...
//	var width = (evt.getWidth() != null && evt.getWidth() != "")  ?  evt.getWidth() : this._theme.event.bubble.width;
//	var height = (evt.getHeight() != null && evt.getHeight() != "")  ?  evt.getHeight() : this._theme.event.bubble.height;
	var width = (evt.getWidth() != 0) ? evt.getWidth() : this._theme.event.bubble.width;
	var height = (evt.getHeight() != 0) ? evt.getHeight() : this._theme.event.bubble.height;
